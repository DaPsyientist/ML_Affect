...
def prepare_automatic(gsr_signal, sample_rate=128, new_sample_rate=40, k=32, epochs=100, batch_size=10):
	...
	# Save the network
	torch.save(model, '/Users/johnnycastillo/Desktop/Affective_Phys/pyEDA/pyEDA/checkpoint.t7')
...
def process_automatic(gsr_signal):
	...
	# Load the network
	model = torch.load('/Users/johnnycastillo/Desktop/Affective_Phys/pyEDA/pyEDA/checkpoint.t7')
	
	# Extract the features
	gsr_signal = np.reshape(gsr_signal, (1, 1800))
